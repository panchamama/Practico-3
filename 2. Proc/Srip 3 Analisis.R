...
### c. Tabla descirptiva con "Summarytools::dfSummary" ###
...
### Tablas de promedio de variables continua por categorias ###
...
# y lo podemos guardar:
ggsave(graph, file="3. Output/graph.png")
...
# y lo podemos guardar:
ggsave(graph_box, file="3. Output/graph.png")
...
# Guardamos
ggsave(graph3, file="3. Output/graph3.png")
...
# Guardamos
ggsave(graph4, file="3. Output/graph4.png")

### Asociacion de 3 varaibles ###
